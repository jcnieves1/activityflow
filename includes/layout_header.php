...
$navItems = [
    ...
    ['key' => 'vacations', 'label' => t('nav.vacations'), 'icon' => 'airplane', 'url' => 'vacations.php'],
  ...
  <aside class="af-sidebar" id="afSidebar">
    ...
    <nav class="af-nav">
      ...
      <?php if (can_manage_task_templates()): ?>
        <a href="<?= e(base_url('task_templates.php')) ?>" class="af-nav-link <?= in_array($activeNav, ['task_templates'], true) ? 'active' : '' ?>"><i class="bi bi-clipboard-check"></i> <span><?= e(t('nav.task_templates')) ?></span></a>
      <?php endif; ?>
      <?php if (is_admin()): ?>
