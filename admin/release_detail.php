...
$unassignedProjects = list_unassigned_projects();
$otherReleases = array_values(array_filter(list_releases(), fn($r) => (int)$r['id'] !== $releaseId));

$pageTitle = $release['name'];
$activeNav = 'admin_releases';
$breadcrumbs = [
    ['label' => t('admin.breadcrumb')],
    ['label' => t('admin.releases_title'), 'url' => base_url('admin/releases.php')],
    ['label' => $release['name']],
];
$pageScripts = [base_url('assets/js/admin_release_detail.js')];
require __DIR__ . '/../includes/layout_header.php';
?>
<div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-3">
  <div>
    <a href="<?= e(base_url('admin/releases.php')) ?>" class="small text-muted text-decoration-none"><i class="bi bi-arrow-left"></i> <?= e(t('admin.back_to_releases')) ?></a>
...
<script>
window.AF_RELEASE_ID = <?= (int)$release['id'] ?>;
window.AF_I18N_RELEASE_DETAIL = {
  ...
  releasesUrl: <?= json_encode(base_url('admin/releases.php')) ?>
};
</script>
