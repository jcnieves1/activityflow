...
<form class="row g-2 af-card mb-3" method="get">
  <div class="col-md-4"><select class="form-select form-select-sm" name="entity_type"><option value="">All entity types</option>
    <?php foreach ($entityTypes as $t): ?><option value="<?= e($t['entity_type']) ?>" <?= $entityType === $t['entity_type'] ? 'selected' : '' ?>><?= e(status_label($t['entity_type'])) ?></option><?php endforeach; ?></select></div>
  <div class="col-md-4"><select class="form-select form-select-sm" name="actor_id"><option value="">All users</option>
...
<div class="af-card p-0">
  <div class="table-responsive">
    <table class="table table-sm table-hover mb-0">
      <thead class="table-light"><tr><th>When</th><th>Entity</th><th>Action</th><th>Actor</th><th>IP</th><th>Change</th></tr></thead>
      <tbody>
      <?php foreach ($logs as $l): ?>
        <tr>
          ...
          <td><?= e($l['actor_name'] ?? 'System') ?></td>
          <td class="small text-muted"><?= e($l['ip_address'] ?? '') ?></td>
          <td class="small">
            <?php if ($l['old_value']): ?><span class="text-danger">old: <?= e(substr($l['old_value'], 0, 80)) ?></span><br><?php endif; ?>
            <?php if ($l['new_value']): ?><span class="text-success">new: <?= e(substr($l['new_value'], 0, 80)) ?></span><?php endif; ?>
          </td>
        </tr>
      <?php endforeach; ?>
      <?php if (!$logs): ?><tr><td colspan="6"><div class="af-empty"><i class="bi bi-journal-text"></i>No audit records match these filters.</div></td></tr><?php endif; ?>
      </tbody>
    </table>
  </div>
</div>
